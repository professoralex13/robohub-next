...
export const ErrorBox: FC<PropsWithChildren> = ({ children }) => (
    <div className="
        mb-4 flex flex-row items-center gap-3
        rounded-md border-2 border-red-400 bg-navy-900 p-3"
    >
...
export const WarningBox: FC<PropsWithChildren> = ({ children }) => (
    <div className="
    mb-4 flex flex-row items-center gap-3
        rounded-md border-2 border-yellow-400 bg-navy-900 p-3"
    >
...
export const MessageBox: FC<PropsWithChildren> = ({ children }) => (
    <div className="
      mb-4 flex flex-row items-center gap-3
        rounded-md border-2 border-green-400 bg-navy-900 p-3"
    >
